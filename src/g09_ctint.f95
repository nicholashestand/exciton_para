...
program g09_ctint
    ...
    write( fno, * ) 'Unorthogonalized Sub Hamiltonian (cm-1)'
...
subroutine print_help()
    ...
    print*, 
    print*, ' This program calculates the charge transfer integrals between'
    print*, ' two molecules by transforming the Hamiltonian into the molec-'
    print*, ' ular orbital basis. The calculation uses output from a Gauss-'
    print*, ' ian 09 calculation.'
    print*,
    print*, ' Usage:'
    print*,
    print*, ' -- help, -h: print this message'
    print*, ' -i file    : specifies the input file containing the names of'
    print*, '              the formatted checkpoint files. If the -m option'
    print*, '              is also given, it reads the input file for info-'
    print*, '              rmation about the G09 calculation to add to the '
    print*, '              G09 input files.'
    print*, ' -o file    : specifies the output file(s)'
    print*, ' -m         : makes three gaussian input files from two xyz '
    print*, '              files of atomic coordinates. The three files are'
    print*, '              for two monomer calculations and one dimer calc-'
    print*, '              ulation. The options are set so that the result-'
    print*, '              ing fch and output files can be used directly   '
    print*, '              with this program. Note that the formatted chec-'
    print*, '              kpoint file needs to be made by the gaussian '
    print*, '              formchk utility. '
    print*, 
    print*, ' To use this program to calculate the charge transfer integra-'
    print*, ' ls, you must first run single point calculations in Gaussian '
    print*, ' 09 of the two molecules of interest and a single point calcu-'
    print*, ' lation of the dimer system. The -m option of this program can'
    print*, ' be used to generate the appropriate Gaussian09 input files if'
    print*, ' xyz coordinate file for the molecules of interest are '
    print*, ' provided.'
    print*, 
    print*, ' The resulting checkpoing files must be converted to formatted'
    print*, ' checkpoint files using the Gaussian09 formcheck utility '
